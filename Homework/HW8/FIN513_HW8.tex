...
\begin{homeworkProblem}
	...
	The main reason was re-securitized product. Even if the RMBS consists
	a pool of subprime ARMs, as long as it has other pools, probability of loss
	for AAA tranche itself is not quite large.
	Actually, about 80\% of pool was AAA tranche at that period.
	Therefore, although cumulative default rate on the pool
