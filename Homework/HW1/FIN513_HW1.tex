...
\item
Since hedging a long position is equivalent to replicating short position, it is required to buy $\frac{1}{(1 + 0.5r_B^E)^{2(T-t)}}$ times notional amount of euros to hedge it. Therefore, the amount to buy spot euro is:
	\begin{equation*}
		10,000,000 \times \frac{1}{(1 + 0.5 \times 0.0325)^{20}} = 7,244,173.2450
	\end{equation*}
\end{enumerate}
...
\begin{enumerate}[(a)]
	\item	%% Sub-Problem(a)
	Since the loan has a fee of 25 basis points, lending 1,000,000 shares of stocks with loan fee is equivalent to lending 997,500 shares of stocks.
	If firm L did not lend out stocks, they will get 997,500 dollars for dividend and pay $997,500 \times 0.3 \times 0.3 = 89,775$ dollars for tax. However, if the firm lend out stocks, they should pay $1,000,000 \times 0.3 = 300,000$ dollars for tax. Therefore, firm L would require at least $300,000 - 89,775 = 210,225$ dollars from firm H.
	\item %% Sub-Problem(b)
	Consider the following agreement.
	\begin{enumerate}[(1)]
		\item Firm L lends 1,000,000 shares to broker.
		\item Broker sells equal amount of shares to firm E, and make forward contracts to repurchase after dividends are paid. It is possible since dividend schedule is certain.
		\item Firm E lends out 1,000,000 shares to firm H.
		\item At maturity of forward contract, broker repurchase stocks and get back to firm L immediately.
	\end{enumerate}
	In this case, since the firm E has an ownership to stocks, E does not have to pay tax. Therefore, if the dividends are appropriately distributed for all parties, all firms would get more profit than (a).
\end{enumerate}
\end{homeworkProblem}
