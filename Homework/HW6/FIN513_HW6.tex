...
\begin{homeworkProblem}
	Assume that face value of the bond is equal to 1.
	\begin{enumerate}[(a)]
		\item	%% Problem (a)
		...
		\item	%% Problem (d)
		Since $F = \frac{p}{1 + R} = \frac{\pi}{1 + e}$, $\frac{\pi}{p} = \frac{1 + e}{1 + R}$.
		Furthermore, because the bond is risky, $e$ must be greater than $R$,
		therefore the inequality $\frac{\pi}{p} = \frac{1 + e}{1 + R} > 1$ holds.
		\item	%% Problem (e)
		As shown in Figure \ref{fig:prob1-asset and bond payoff},
		payoff of a bond has a upper bound unlike payoff of asset.
		In other words, although asset value becomes larger than face value of bond,
		payoff of bond does not increases as asset value increases.
%----------------------------------------------------------------------------------------
	%% ASSET AND BOND PAYOFF
		\begin{figure}[ht]
			\centering
			\begin{subfigure}{.5\textwidth}
				\includegraphics[scale = 0.45]{HW6_prob1_asset.png}
				\caption{Asset}
				\label{fig:prob1-asset plot}
			\end{subfigure}%
			\begin{subfigure}{.5\textwidth}
				\includegraphics[scale = 0.45]{HW6_prob1_bond.png}
				\caption{Bond}
				\label{fig:prob1-bond plot}
			\end{subfigure}
			\caption{Payoff of asset and bond}
			\label{fig:prob1-asset and bond payoff}
		\end{figure}
%----------------------------------------------------------------------------------------
		Therefore, true expected return of a bond would be lower than
		expected return of the asset, which is 12\%, hence by (c), price of bond
		would be larger than $\frac{\pi}{1 + \mu} = \frac{0.97}{1.12}$.
	\end{enumerate}
\end{homeworkProblem}
...
\begin{homeworkProblem}
	...
	stock prices from about 0 to 40. The range of stock prices corresponds to
...
%----------------------------------------------------------------------------------------
		...
		In other words, since risk of an asset is measured by volatility,
		if firm's total risk increases, then the proportion of equity risk
		among total firm risk decreases.
		...
		if $\sigma_V$ is less than threshold level. At first glance, it seems weird
		because in many finance context, risk premium increases as risk increases.
		Of course, risk premium increases as risk increases, however,
		it is important to note that the risk which makes risk premium increase
		is ``systematic'' risk, not idiosyncratic risk.
		In this case, the increased risk is idiosyncratic risk. It means that
		firm's total risk was increased, but systematic risk remains constant.
		As the proportion of equity risk among total firm risk decreases as
		firm risk increases, ``systematic'' equity risk decreases since total
		systematic risk remains constant. In other words, increase in idiosyncratic
		risk transferred systematic risk from equity holder to debt holder. Hence
		risk premium of equity decreases.
		\item	%% Problem (c)
