...
%----------------------------------------------------------------------------------------	
	\item		%% problem (b)
	By using the following algorithm, it is possible to implement dynamic replication strategy.
	\begin{algorithm}[ht]
	\caption{Monte-Carlo Simulation for Dynamic Replication\label{alg}} 
