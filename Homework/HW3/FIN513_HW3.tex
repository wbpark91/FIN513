...
%----------------------------------------------------------------------------------------
	\item %%(b)
	\textbf{True.} Suppose $p(K, T) > B_{t, T} \cdot  K$. Then by selling short a put option with strike price $K$ and maturity $T$, and buying a zero coupon bond with face value $K$ and maturity $T$. 
%----------------------------------------------------------------------------------------
	\item %%(c)
%----------------------------------------------------------------------------------------
	\item %%(d)
